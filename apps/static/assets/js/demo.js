...
$.notify({
	...
	title: 'Welcome!',
	message: 'Welcome to the FORGE Security dashboard.',
},{
	type: 'info',
	placement: {
		from: "bottom",
...
var statisticsChart = new Chart(ctx, {
	...
	data: {
		...
		datasets: [ {
			...
			fill: true,
			borderWidth: 2,
			data: window.package.web_month_data
		}, {
			label: "Twitter Scrapes",
			borderColor: '#fdaf4b',
			...
			fill: true,
			borderWidth: 2,
			data: window.package.twitter_month_data
		}]
	},
	options : {
		responsive: true, 
